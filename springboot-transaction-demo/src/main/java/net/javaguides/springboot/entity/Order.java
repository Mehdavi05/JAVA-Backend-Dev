...
public class Order {
    ...
    public Order(Long id, String orderTackingNumber, int totalQuantity, BigDecimal totalPrice, String status, LocalDateTime dateCreated, LocalDateTime lastUpdated, Long shoppingCartId) {
        this.id = id;
